...
#pragma region Target
	...
	Resolvernum.SetFileId("Resolvernum");
	Resolvernum.AddItem("Off"); //0
	Resolvernum.AddItem("1"); // 1
	Resolvernum.AddItem("2"); // 2
	Resolvernum.AddItem("3"); // 3
	Resolvernum.AddItem("4"); // 4
	TargetGroup.PlaceLabledControl("Resolver", this, &Resolvernum);
...
#pragma region AntiAim
	...
	advancedAA.SetFileId("advanced_AA");
	AntiAimGroup.PlaceLabledControl("Advanced AA", this, &advancedAA);

	if (Menu::Window.RageBotTab.advancedAA.GetState()) {
		AntiAimYaw_a_move.SetFileId("AntiAimYaw_a_move");
		AntiAimYaw_a_move.AddItem("None");
		AntiAimYaw_a_move.AddItem("Backward");
		AntiAimYaw_a_move.AddItem("SW Switch");
		AntiAimYaw_a_move.AddItem("Fake Spin");
		AntiAimGroup.PlaceLabledControl("move Yaw", this, &AntiAimYaw_a_move);
	}
...
#pragma region Colors
	...
	cham3.PlaceLabledControl("T InVis: Red", this, &vchamtr);

	vchamtg.SetFileId("chamt2");
	vchamtg.SetBoundaries(0, 255);
	vchamtg.SetValue(0);
	cham3.PlaceLabledControl("T InVis: Green", this, &vchamtg);

	vchamtb.SetFileId("chamt3");
	vchamtb.SetBoundaries(0, 255);
	vchamtb.SetValue(40);
	cham3.PlaceLabledControl("T InVis: Blue", this, &vchamtb);
	...
	cham4.PlaceLabledControl("CT InVis: Red", this, &vchamctr);

	vchamctg.SetFileId("chamct2");
	vchamctg.SetBoundaries(0, 255);
	vchamctg.SetValue(10);
	cham4.PlaceLabledControl("CT InVis: Green", this, &vchamctg);

	vchamctb.SetFileId("chamct3");
	vchamctb.SetBoundaries(0, 255);
	vchamctb.SetValue(255);
	cham4.PlaceLabledControl("CT InVis: Blue", this, &vchamctb);
	...
	chamtr.SetValue(255);
	cham.PlaceLabledControl("T Vis: Red", this, &chamtr);

	chamtg.SetFileId("ichamt2");
	chamtg.SetBoundaries(0, 255);
	chamtg.SetValue(90);
	cham.PlaceLabledControl("T Vis: Green", this, &chamtg);

	chamtb.SetFileId("ichamt3");
	chamtb.SetBoundaries(0, 255);
	chamtb.SetValue(10);
	cham.PlaceLabledControl("T Vis: Blue", this, &chamtb);
	...
	chamctr.SetValue(5);
	cham2.PlaceLabledControl("CT Vis: Red", this, &chamctr);

	chamctg.SetFileId("ichamct2");
	chamctg.SetBoundaries(0, 255);
	chamctg.SetValue(170);
	cham2.PlaceLabledControl("CT Vis: Green", this, &chamctg);

	chamctb.SetFileId("ichamct3");
	chamctb.SetBoundaries(0, 255);
	chamctb.SetValue(255);
	cham2.PlaceLabledControl("CT Vis: Blue", this, &chamctb);
...
//	OptionsGroup.SetSize(193, 430);
	...
	ChamsXqz.SetFileId("ChamsXqz");
	OptionsGroup.PlaceLabledControl("Chams:XQZ", this, &ChamsXqz);

	OptionsSkeleton.SetFileId("opt_bone");
	OptionsGroup.PlaceLabledControl("Skeleton", this, &OptionsSkeleton);

	//lby.SetFileId("otr_lbyindicator");
	//BoxGroup.PlaceCheckBox("LBY Indicator", this, &lby);
	...
	pLocalOpacity.AddItem("Default");
	pLocalOpacity.AddItem("Clear");
	pLocalOpacity.AddItem("Chams");
	pLocalOpacity.AddItem("Wire");
	pLocalOpacity.AddItem("Glass");
	ChamsGroup.PlaceLabledControl("Scoped Material", this, &pLocalOpacity);*/
...
#pragma region Filters
	...
	OtherSpreadCrosshair.SetFileId("OtherSpreadCrosshair");
	FiltersGroup.PlaceLabledControl("SpreadCrosshair", this, &OtherSpreadCrosshair);

	OtherRecoilCrosshair.SetFileId("OtherRecoilCrosshair");
	FiltersGroup.PlaceLabledControl("Recoil Crosshair", this, &OtherRecoilCrosshair);
	...
	bManualArrows.SetFileId("bManualArrows");
	FiltersGroup.PlaceLabledControl("Manual Arrows (Inwork)", this, &bManualArrows);
	...
	FiltersGroup.PlaceLabledControl("Hitmarker", this, &OtherHitmarker);

	HitmarkerSound.SetFileId("otr_hitmarkersound");
	FiltersGroup.PlaceLabledControl("Hitmarker Sound", this, &HitmarkerSound);

	NightMode.SetFileId("otr_nightmode");
	FiltersGroup.PlaceLabledControl("Night Mode", this, &NightMode);
...
/*	KnifeEnable.SetFileId("KnifeEnable");
	OtherGroup.PlaceLabledControl("Enable Knifes", this, &KnifeEnable);


	KnifeSkin.SetFileId("knife_skin");
	OtherGroup.PlaceLabledControl("Skin", this, &KnifeSkin);
