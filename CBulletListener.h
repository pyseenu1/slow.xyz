...
public:
	...
	{
		if (!strcmp(event->GetName(), "bullet_impact") && options.Rage.BulletTracers && Menu::Window.VisualsTab.Active.GetState())
		{
	...
	void OnStudioRender()
	{
		if (options.Rage.BulletTracers && Menu::Window.VisualsTab.Active.GetState()) {
